              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @else
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link" href="{{route('profile', Auth::user()->name)}}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            {{ Auth::user()->name }}
                        </a>
                    </li>
                    <li>
        ...
        <div class="row">
          <div class="col-auto">
            <div class="card p-1 mb-1">
              <?php foreach ($views_user as $user): ?>
              <div class="card-body">
                <ul>
                  <li style="display: flex">
                    <p><span>Date: </span>{{$user->name}}</p>
                    <p><span>Date: </span>{{$user->password}}</p>
                  </li>
                </ul>
