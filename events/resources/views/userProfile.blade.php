        ...
        <div class="row">
          <div class="col-3 h-100 profilebg">
              ...
              <div class="change-profile-data">
                <span>
                  <a href="{{route('edit-profile', Auth::user()->id)}}" role="button">Edit Profile</a>
                </span>
              </div>
              @if(session('epass'))
              <div class="elassone">
              ...
              @endif
              <form class="" action="{{route('password', Auth::user()->id)}}" method="POST">
                @csrf
              <p class="textpassword">Change Your Password:</p>
                <label for="old-password" class="col-md-4 col-form-label text-md-right textpassword">Enter old password:</label>
                <input id="old-password" type="password" class="form-control @error('email') is-invalid @enderror" name="old-password" value="{{ old('email') }}" required>
                  </br>
                <label for="new-password" class="col-md-4 col-form-label text-md-right textpassword">Enter New password:</label>
                <input id="new-password" type="password" class="form-control @error('email') is-invalid @enderror textpassword" name="new-password" value="{{ old('email') }}" required>
                  </br>
